<template>
  <div>
    ...
    <div v-if="show">
      <!-- Hero Area -->
      <b-jumbotron header="JVYY" fluid>
        <p>Music Producer, Web Developer, Martial Artist & Lover of Pizza</p>
      </b-jumbotron>
      <!-- Hero Area -->
    ...
    <b-container fluid="md">
      <b-row>
        ...
        v-bind:key="service.id">
          <img width="40" :src="service.icon" alt="icon" />
          <h2>{{ service.title }}</h2>
          <p>{{ service.desc }}</p>
          <button><a href="mailto:prodijvy@gmail.com">Learn More</a></button>
        </b-col>
      </b-row>
    </b-container>
    <!-- Services Section -->
    ...
    return {
      ...
      services: [
        ...
        },
        {
          ...
          desc:
            "I will design and build your very own professional artist website to host your tracks, merch et cetera.. ",
        },
        {
          id: 3,
          icon: icon3,
